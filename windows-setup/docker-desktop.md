...
canonicalUrl: https://learn.microsoft.com/en-us/windows/wsl/tutorials/wsl-containers
...
locale: en-us
document_id: 403a33a6-304c-2ded-9ea8-4d70bc5f17ba
document_version_independent_id: 93b6a9ef-08ba-be90-736e-27515fb0f4da
updated_at: 2026-01-07T20:49:00.0000000Z
original_content_git_url: https://github.com/MicrosoftDocs/WSL/blob/live/WSL/tutorials/wsl-containers.md
gitcommit: https://github.com/MicrosoftDocs/WSL/blob/9f95f1ea9e245f56799e6cdd934879018d1b797b/WSL/tutorials/wsl-containers.md
git_commit_id: 9f95f1ea9e245f56799e6cdd934879018d1b797b
site_name: Docs
depot_name: WS.wsl
...
word_count: 2125
asset_id: tutorials/wsl-containers
moniker_range_name: 
monikers: []
item_type: Content
source_path: WSL/tutorials/wsl-containers.md
cmProducts:
...
platformId: 429917cd-5309-8f6c-d82f-27971545a574
---
...
Continuous availability, using Docker containers with tools like [Kubernetes](/en-us/azure/aks/), is another reason for the popularity of containers. This enables multiple versions of your app container to be created at different times. Rather than needing to take down an entire system for updates or maintenance, each container (and its specific microservices) can be replaced on the fly. You can prepare a new container with all of your updates, set up the container for production, and just point to the new container once it's ready. You can also archive different versions of your app using containers and keep them running as a safety fallback if needed.

To learn more, check out [Introduction to Docker containers](/en-us/training/modules/intro-to-docker-containers/).

## Prerequisites

- WSL version 1.1.3.0 or later.
- Windows 11 [Home and Pro](/en-us/lifecycle/products/windows-11-home-and-pro), or [Enterprise and Education](/en-us/lifecycle/products/windows-11-enterprise-and-education), Windows 10 22H2 (build 19045) 64-bit [Home and Pro](/en-us/lifecycle/products/windows-10-home-and-pro), or [Enterprise and Education](/en-us/lifecycle/products/windows-10-enterprise-and-education) (Recommended).

    Windows 10 21H2 (build 19044) 64-bit [Home and Pro](/en-us/lifecycle/products/windows-10-home-and-pro), or [Enterprise and Education](/en-us/lifecycle/products/windows-10-enterprise-and-education) (Minimum). [Update Windows](ms-settings:windowsupdate)
- 64-bit processor with [Second Level Address Translation (SLAT)](https://en.wikipedia.org/wiki/Second_Level_Address_Translation).
- 4GB system RAM or more.
- Enable hardware virtualization in BIOS.
- [Install WSL and set up a user name and password for your Linux distribution running in WSL 2](../install).
...
- [Install Windows Terminal](/en-us/windows/terminal/get-started)*(optional)*. This will provide the best experience, including the ability to customize and open multiple terminals in the same interface (including Ubuntu, Debian, PowerShell, Azure CLI, or whatever you prefer to use).
...
To learn how to install Docker on Windows Server, see [Get started: Prep Windows for containers](/en-us/virtualization/windowscontainers/quick-start/set-up-environment).
...
To install Docker (after already [installing WSL](../install)):
...
2. Once installed, start Docker Desktop from the Windows Start menu, then select the Docker icon from the hidden icons menu of your taskbar. Right-click the icon to display the Docker commands menu and select "Settings". ![Docker Desktop dashboard icon](../media/docker-starting.png)
3. Ensure that "Use the WSL 2 based engine" is checked in **Settings** &gt; **General**. ![Docker Desktop general settings](../media/docker-running.png)
4. Select from your installed WSL 2 distributions which you want to enable Docker integration on by going to: **Settings** &gt; **Resources** &gt; **WSL Integration**. ![Docker Desktop resource settings](../media/docker-dashboard.png)
...
1. For this example, I'll use the source code from my [Hello World tutorial for Django](/en-us/windows/python/web-frameworks#hello-world-tutorial-for-django) in the Python development environment set up docs. You can skip this step if you prefer to use your own project source code. To download my HelloWorld-Django web app from GitHub, open a WSL terminal (Ubuntu for example) and enter:
...
Possible errors you might encounter with this deprecated wsl context include: "docker wsl open //./pipe/docker\_wsl: The system cannot find the file specified." or "error during connect: Get http://%2F%2F.%2Fpipe%2Fdocker\_wsl/v1.40/images/json?all=1: open //./pipe/docker\_wsl: The system cannot find the file specified."
...
For more help with general troubleshooting issues in WSL, see the [Troubleshooting](../troubleshooting) doc.
