...
5. [Admin Console](admin-console/admin-console.md) — restore NuGet packages, build the solution, and confirm the admin login
6. [Mise Tools](mise/mise-tools.md) — install Node.js via mise (required for Spire; not needed for Admin Console)
7. [Spire Setup](spire/spire-setup.md) — run `npm install`, configure the API URL, and start the frontend
