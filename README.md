...
1. [mise (Polyglot Tool Manager)](wsl/mise/mise-install.md) — replaces Volta, Bob, and Pyenv (see [Migrating to mise](migrations/migrate-to-mise.md) if upgrading from an older setup)
